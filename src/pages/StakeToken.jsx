      ...
      <section className="innerSec stakeSec pt-md-0 pt-5">
        <Container>
          <Row>
                ...
                <div className="ypBox__content">
                    ...
                    <Row>
                      ...
                      <Col md="4" xs="12">
                        <div className="ypRight text-right">
                          <span className="cValue cValue-light">30</span>
                  ...
                  <div className="ypBox__block">
                    <Row>
                      ...
                      <Col md="4" xs="12">
                        <div className="ypRight text-right">
                          <h5><span className="text-primary font-weight-bold">$YOP</span><span className="pl-3 font-weight-normal">0</span></h5>
                        </div>
                      </Col>
                    </Row>
                  </div>
                  <div className="ypBox__block">
                    <Row>
                      <Col md="8" xs="12">
                        <div className="ypLeft"><img className="ypdIcon" src={Icon4} /> <span className="small">Only 1 stake is possible per wallet. Staked Tokens will be locked for the full duration of the stake period. Unstaking will not be possible.</span></div>
                      </Col>
                      <Col md="4" xs="12">
                        <div className="ypRight text-right">
            ...
            <Col md="3" xs="12">
              <div className="ypBox ypBox--rBlock text-center">
